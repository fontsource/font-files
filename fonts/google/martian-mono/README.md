...
```javascript
npm install @fontsource/martian-mono
```

Within your app entry file or site component, import it in.

```javascript
import "@fontsource/martian-mono"; // Defaults to weight 400
import "@fontsource/martian-mono/400.css"; // Specify weight
import "@fontsource/martian-mono/400-italic.css"; // Specify weight and style
```
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/martian-mono).

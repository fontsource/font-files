...
[![npm (scoped)](https://img.shields.io/npm/v/@fontsource/asap?color=brightgreen)](https://www.npmjs.com/package/@fontsource/asap) [![Generic badge](https://img.shields.io/badge/fontsource-passing-brightgreen)](https://github.com/fontsource/fontsource) [![Monthly downloads](https://badgen.net/npm/dm/@fontsource/asap)](https://github.com/fontsource/fontsource) [![Total downloads](https://badgen.net/npm/dt/@fontsource/asap)](https://github.com/fontsource/fontsource)

The CSS and web font files to easily self-host the “Asap” font. Please visit the main [Fontsource website](https://fontsource.org/fonts/asap) to view more details on this package.
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/asap).

...
```javascript
npm install @fontsource/stalinist-one
```
...
import "@fontsource/stalinist-one/400.css"; // Specify weight
import "@fontsource/stalinist-one/400-italic.css"; // Specify weight and style
```
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/stalinist-one).

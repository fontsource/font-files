...
```javascript
npm install @fontsource/kantumruy
```
...
import "@fontsource/kantumruy/400.css"; // Specify weight
import "@fontsource/kantumruy/400-italic.css"; // Specify weight and style
...
Copyright (c) 2013, Tep Sovichet (it4ug.net sovichet.tep@gmail.com), with Reserved Font Name 'Kantumruy'

...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/petrona).
...
Copyright 2019 The Petrona Project Authors (https://github.com/RingoSeeber/Petrona) Petrona-Italic[wght].ttf: Copyright 2019 The Petrona Project Authors (https://github.com/RingoSeeber/Petrona)

...
```javascript
npm install @fontsource/encode-sans
```
...
import "@fontsource/encode-sans/400.css"; // Specify weight
import "@fontsource/encode-sans/400-italic.css"; // Specify weight and style
```
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/encode-sans).

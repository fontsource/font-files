...
```javascript
npm install @fontsource/noto-sans-linear-a
```
...
import "@fontsource/noto-sans-linear-a/400.css"; // Specify weight
import "@fontsource/noto-sans-linear-a/400-italic.css"; // Specify weight and style
```
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/noto-sans-linear-a).
...
Copyright 2022 The Noto Project Authors (https://github.com/notofonts/linear-a)

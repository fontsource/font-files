...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/sulphur-point).
...
Copyright 2019 The Sulphur Point Project Authors (https://github.com/noponies) SulphurPoint-Regular.ttf: Copyright 2019 The Sulphur Point Project Authors (https://github.com/noponies) SulphurPoint-Bold.ttf: Copyright 2019 The Sulphur Point Project Authors (https://github.com/noponies)

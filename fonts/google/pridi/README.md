...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Fontsource website](https://fontsource.org/fonts/pridi).
...
Copyright (c) 2015, Cadson Demak (info@cadsondemak.com) Pridi-Light.ttf: Copyright (c) 2015, Cadson Demak (info@cadsondemak.com) Pridi-Regular.ttf: Copyright (c) 2015, Cadson Demak (info@cadsondemak.com) Pridi-Medium.ttf: Copyright (c) 2015, Cadson Demak (info@cadsondemak.com) Pridi-SemiBold.ttf: Copyright (c) 2015, Cadson Demak (info@cadsondemak.com) Pridi-Bold.ttf: Copyright (c) 2015, Cadson Demak (info@cadsondemak.com)

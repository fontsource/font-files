...
```javascript
npm install @fontsource/arima-madurai
```
...
import "@fontsource/arima-madurai/400.css"; // Specify weight
import "@fontsource/arima-madurai/400-italic.css"; // Specify weight and style

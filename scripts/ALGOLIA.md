# Language index version

Every Algolia record carries `languageIndexVersion`: SHA-256 of the JSON array of `[familyId, sortedLanguageIds]` pairs, ordered lexically by family ID, covering every registry family.
